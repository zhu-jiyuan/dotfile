...
const float DURATION = 0.12; // total animation time
const float TRAIL_SIZE = 0.35; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
const float THRESHOLD_MIN_DISTANCE = 2.25; // min distance to show trail (units of cursor height)
