...
create_symlinks "waybar" "$config_dir/waybar"
create_symlinks "fastfetch" "$config_dir/fastfetch"
create_symlinks "hypr" "$config_dir/hypr"
create_symlinks "mako" "$config_dir/mako"
create_symlinks "fcitx5" "$config_dir/fcitx5"
